                        ...
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <div class="form-group">
                                ...
                                <select id="kelasDropdown" class="form-control" style="width: 150px; display: inline-block;">
                                    <option value="7A" {{ $kelas == '7A' ? 'selected' : '' }}>7A</option>
                                    <option value="7B" {{ $kelas == '7B' ? 'selected' : '' }}>7B</option>
                                    <option value="7C" {{ $kelas == '7C' ? 'selected' : '' }}>7C</option>
                                    <option value="7D" {{ $kelas == '7D' ? 'selected' : '' }}>7D</option>
                                    <option value="7E" {{ $kelas == '7E' ? 'selected' : '' }}>7E</option>
                                    <option value="7F" {{ $kelas == '7F' ? 'selected' : '' }}>7F</option>
                                    <option value="7G" {{ $kelas == '7G' ? 'selected' : '' }}>7G</option>
                                    <option value="7H" {{ $kelas == '7H' ? 'selected' : '' }}>7H</option>
                                    <option value="7I" {{ $kelas == '7I' ? 'selected' : '' }}>7I</option>
                                </select>
